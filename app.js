...
(() => {
  ...
  const icons = {
    ...
    wa: `<svg width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden="true">
      <path d="M12 2a10 10 0 0 0-8.6 15.1L2 22l5-1.3A10 10 0 1 0 12 2z" fill="currentColor" opacity=".22"/>
    ...
    pin: `<svg width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden="true">
      <path d="M12 22s7-5.2 7-12a7 7 0 1 0-14 0c0 6.8 7 12 7 12z" fill="currentColor" opacity=".22"/>
    ...
    social: `<svg width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden="true">
      <path d="M17 8a3 3 0 1 0-2.8-4H9.8A3 3 0 1 0 7 8c.5 0 .9-.1 1.3-.3l3 2A3 3 0 0 0 11 11c0 .5.1 1 .3 1.4l-3 2A3 3 0 1 0 9.8 20h4.4A3 3 0 1 0 17 16c-.5 0-1 .1-1.4.3l-3-2A3 3 0 0 0 13 11c0-.5-.1-1-.3-1.4l3-2c.4.2.8.3 1.3.3z" fill="currentColor" opacity=".18"/>
  ...
  document.querySelectorAll("[data-btn-icon]").forEach(btn => {
    ...
    const svg = icons[k];
    if (!svg) return;
    if (!btn.querySelector("svg")) btn.insertAdjacentHTML("afterbegin", svg);
  });
})();
